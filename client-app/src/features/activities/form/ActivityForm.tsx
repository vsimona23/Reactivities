...
import {v4 as uuid} from 'uuid'; // v4 is a version chosen here
...
const ActivityForm: React.FC<IProps> = ({setEditMode, activity: initialFormState, createActivity, editActivity, submitting }) => {
    ...
    // here creating a function for initial state before creating an activity
    ...
    // here is a function to handle different inputs and update state
    ...
    return (
        <Segment clearing>
            <Form onSubmit={handleSubmit}>
                ...
                {/* TextArea is using React from event, not change event */}
